...
import static ru.retail.service.app.posting.client.bonuses.app.metrics.name.BonusControllerMetrics.GET_BALANCE_BONUSES_SUCCESS_REQUESTS;
import static ru.retail.service.app.posting.client.bonuses.app.metrics.name.BonusControllerMetrics.GET_BALANCE_BONUSES_SYSTEM_FAIL;
...
@Service("getBalanceMetricService")
public class GetBalanceControllerMetricServiceImpl implements MetricService {

    private final Counter controllerSuccessCounter;
    private final Counter controllerSystemFail;

    public GetBalanceControllerMetricServiceImpl(MeterRegistry meterRegistry) {
        this.controllerSuccessCounter = createCounter(meterRegistry,
                GET_BALANCE_BONUSES_SUCCESS_REQUESTS,
                SUCCESS_REQUESTS_DESC
        );

        this.controllerSystemFail = createCounter(meterRegistry,
                GET_BALANCE_BONUSES_SYSTEM_FAIL,
                SYSTEM_FAIL_DESC
        );
    }
    ...
    private static Counter createCounter(
        ...
        return Counter.builder(name)
                ...
                .tags(TAG_OPERATION, GET_BALANCE_BONUSES_OPERATION_VALUE)
