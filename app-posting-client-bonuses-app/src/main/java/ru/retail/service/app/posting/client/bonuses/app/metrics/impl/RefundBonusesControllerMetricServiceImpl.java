...
import static ru.retail.service.app.posting.client.bonuses.app.metrics.name.BonusControllerMetrics.REFUND_BONUSES_SUCCESS_REQUESTS;
import static ru.retail.service.app.posting.client.bonuses.app.metrics.name.BonusControllerMetrics.REFUND_BONUSES_SYSTEM_FAIL;
...
@Service("refundBonusesMetricService")
public class RefundBonusesControllerMetricServiceImpl implements MetricService {

    private final Counter controllerSuccessCounter;
    private final Counter controllerSystemFail;

    public RefundBonusesControllerMetricServiceImpl(MeterRegistry meterRegistry) {
        this.controllerSuccessCounter = createCounter(meterRegistry,
                REFUND_BONUSES_SUCCESS_REQUESTS,
                SUCCESS_REQUESTS_DESC
        );

        this.controllerSystemFail = createCounter(meterRegistry,
                REFUND_BONUSES_SYSTEM_FAIL,
                SYSTEM_FAIL_DESC
        );
    }
    ...
    private static Counter createCounter(
        ...
        return Counter.builder(name)
                ...
                .tags(TAG_OPERATION, REFUND_BONUSES_OPERATION_VALUE)
